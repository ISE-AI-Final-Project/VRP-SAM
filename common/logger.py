...
from .utils import is_main_process, reduce_metric, save_on_master
...
class Logger:
    ...
    def initialize(cls, args, training):
        ...
        cls.logpath = os.path.join("logs", logpath + logtime)
    ...
    def log_params(cls, model):
        ...
        for k in model.state_dict().keys():
            ...
            if [
                i for i in ["layer0", "layer1", "layer2", "layer3", "layer4"] if i in k
            ]:
